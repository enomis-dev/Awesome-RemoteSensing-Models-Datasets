...
## Datasets
- BreizhSR: multi-temporal cross-sensor super-resolution of satellite imagery https://zenodo.org/records/11551220
- The WorldStrat Dataset: Open High-Resolution Satellite Imagery With Paired Multi-Temporal Low-Resolution https://zenodo.org/records/6810792
- SEN2VENµS: a dataset for the training of Sentinel-2 super-resolution algorithms https://zenodo.org/records/6514159
- LACAS2K: A Large-Scale Aerial and Satellite Image Dataset for Image Super-Resolution of VHR Remote Sensing Imagery https://ieee-dataport.org/documents/lacas2k-large-scale-aerial-and-satellite-image-dataset-image-super-resolution-vhr-remote

## Others
The following list of model is not specifically applied to remote sensing images but could be applied for super resolution tasks.
